...
keywords: ["cloudbase", "auth", "web", "frontend", "authentication", "云开发", "身份认证", "前端认证", "Web SDK", "登录", "注册"]
...
This power provides comprehensive guidance for implementing CloudBase authentication in web applications using the CloudBase Web SDK (@cloudbase/js-sdk@2.x). It covers all login flows, user management, session handling, and frontend authentication best practices.

Whether you're building login/sign-up flows, managing user sessions, or integrating CloudBase identity with your backend, this power provides complete patterns and APIs for frontend web authentication.
...
- Direct HTTP API calls (use the **CloudBase HTTP Auth** skill instead)
...
**Problem:** Authentication fails with domain error
**Cause:** Domain not whitelisted in CloudBase console
**Solution:**
1. Open CloudBase console: `https://tcb.cloud.tencent.com/dev?envId={envId}#/identity/login-manage`
2. Go to 安全域名 settings
3. Add your domain to the whitelist
4. Include both development (localhost) and production domains

**Problem:** SMS/Email verification not working
**Cause:** Login method not enabled or templates not configured
**Solution:**
1. Enable the required login method in console
2. Configure SMS/Email templates
3. Verify phone number format includes country code (+86)

**Problem:** `onLoginStateChanged` not firing
**Cause:** Multiple SDK instances or incorrect initialization
**Solution:**
1. Use single shared SDK instance
2. Initialize synchronously at app startup
3. Avoid dynamic imports or async wrappers

## Best Practices

- Initialize SDK once at application startup
- Use single shared auth instance across the application
- Always handle authentication errors gracefully
- Implement proper loading states and user feedback
- Use HTTPS in production environments
- Whitelist all domains in CloudBase console
